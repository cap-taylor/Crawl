...
> 최종 업데이트: 2025-11-06 18:10

## 📝 커밋 히스토리
```
92d1088 - 2025-11-06 18:10 : fix: 83→98 건너뛰기 + 로그 복사 크래시 수정 (v1.8.5)
96158a7 - 2025-11-05 16:17 : fix: "FOR YOU 연관 추천" 섹션 필터링 수정 (v1.5.9)
65a71f6 - 2025-11-05 15:51 : docs: v1.5.7 시행착오 문서 업데이트
3c08801 - 2025-11-05 15:43 : fix: 상품 수집 순서 개선 + 조금씩 스크롤 (v1.5.7)
af14f3a - 2025-11-04 17:22 : feat: 캡차 자동 포커스 + 설치 가이드 추가 (v1.4.7)
edb1fe3 - 2025-11-04 13:59 : fix: 배치 처리 + GUI 아코디언 복원 (v1.3.5)
